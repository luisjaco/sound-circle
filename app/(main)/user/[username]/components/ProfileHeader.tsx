        ...
        <div className="py-6 border-b border-gray-800">
            ...
            <div className='flex justify-around mb-6'>
                ...
                <div className="text-center">
                    ...
                    <div className="flex items-center gap-4 bg-[#181818] px-5 py-1.5 rounded-full">
                        <svg
                        ...
                        <span className="text-md text-gray-300">Spotify</span>
                    </div>

                    <div className="flex items-center gap-4 bg-[#181818] px-5 py-1.5 rounded-full">
                        <Music className="w-8 h-8 text-[#FA2D48]" />
                        <span className="text-md text-gray-300">Apple Music</span>
                    </div>
